...
| [온보딩_입문서.pdf](온보딩_입문서.pdf) | 단어 모를 때 (PR=과제검사, Docker=레시피박스) |
| [개발가이드_마스터.pdf](개발가이드_마스터.pdf) §3 | 전체 스토리라인 10페이지·심사기준 매핑 |
| [역할_백엔드.pptx](../roles/역할_백엔드.pptx) | 박진 역할 7슬라이드 요약 |
...
1. **5분 시도** — 온보딩_입문서.pdf p6 "막힘 처방전 7가지" 먼저
