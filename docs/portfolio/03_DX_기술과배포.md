...
- **최종 배포**: AWS EC2(서울, ap-northeast-2) **4 vCPU / 15 GiB RAM** 인스턴스(`i-05729eb9a032b55d2`, 공인 IP `54.116.75.169`)로 이전·운영.
...
> **개발/부하검증 환경(이전 단계)**: 개발 및 2026-06-08 부하검증은 GCP e2-standard-2(2 vCPU) **공용 dev 박스**(`uis-capstone`, 34.47.113.176)에서 수행했다(아래 §9). 이후 운영 배포를 위해 AWS EC2로 이전했다.
